...
function _hrb_register_admin_scripts() {
	...
	wp_register_script( 'hrb-admin-settings', get_template_directory_uri() . '/includes/admin/scripts/settings.js', array( 'jquery' ), HRB_VERSION, true );
	wp_register_script( 'hrb-admin-project-edit', get_template_directory_uri() . '/includes/admin/scripts/project-edit.js', array( 'validate' ), HRB_VERSION, true );

	wp_register_style( 'hrb-jquery-ui', get_template_directory_uri() . '/styles/jqueryui/jquery-ui.min.css' );
}
...
function _hrb_enqueue_admin_scripts( $hook ) {
	...
	if ( strpos( $hook, 'page_app-settings' ) !== false ) {
		...
		hrb_register_enqueue_styles( array( 'font-awesome' ), $admin = true );
		return;
	}
...
function _hrb_disable_admin_project_creation() {
	...
	$url = esc_url_raw( get_the_hrb_project_create_url() );
...
function _hrb_disable_admin_project_editing() {
	...
	$url = esc_url_raw( get_the_hrb_project_edit_url( $post_id ) );

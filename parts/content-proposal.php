...
<div class="row single-bid">
	...
	<div class="large-2 small-3 columns bid-terms">
		<?php if ( current_user_can( 'view_bid', $proposal->get_id() ) ) : ?>
			<div class="bid"><span class="proposal-amount"><?php appthemes_display_price( $proposal->amount ); ?></span> <span class="proposal-delivery"><?php printf( __( 'in %s ', APP_TD ), get_the_hrb_project_budget_units( $proposal->project, $proposal->_hrb_delivery ) ); ?></span> </div>
		<?php else : ?>
	...
	<div class="large-2 columns review-meta">
		...
		<span><?php echo $user_reviews = appthemes_get_user_total_reviews( $proposal->user_id ); ?> <?php echo _n( 'Review', 'Reviews', $user_reviews, APP_TD ); ?></span>

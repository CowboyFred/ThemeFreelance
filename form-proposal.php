	...
	<div class="row">
		<div class="large-12 columns proposal-meta">
			...
			<fieldset class="large-4 columns average">
				<span class="project-avg-bid"><i class="icon i-avg-proposals"></i><small><?php _e( 'Avg. Budget:', APP_TD  ); ?></small> <?php echo appthemes_display_price( appthemes_get_post_avg_bid( $proposal->project->ID ) ); ?></span>
			</fieldset>
			...
			<div class="large-6 columns">
				<div class="row collapse">
					...
					<div class="large-7 small-7 columns">
						<input id="amount" name="amount" type="text" class="required" value="<?php echo esc_attr( $proposal->amount ); ?>"/>
					</div>
				</div>
			</div>
			<div class="large-6 columns">
				<div class="row collapse">
					...
					<div class="large-6 small-6 columns">
						<input id="delivery" name="delivery" type="text" class="proposal-delivery required" value="<?php echo esc_attr( $proposal->_hrb_delivery ); ?>"/>
					</div>

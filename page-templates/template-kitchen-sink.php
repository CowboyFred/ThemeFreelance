<?php
/**
 * Foundation Framework v6.4 testing template.
 *
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<section class="overview">
					...
					<h1>This template tests <a href="http://foundation.zurb.com/sites/docs/kitchen-sink.html" target="_blank">Foundation Framework v6.4</a> page components.</h1>
